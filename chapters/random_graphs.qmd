...
#| out.width: 70%
#| cap-location: margin
#| fig.cap: "[Image source](http://mytechroad.com/markov-chain-branching-process/)."
knitr::include_graphics("http://1.bp.blogspot.com/-Y59SK92Nd0c/VIoqelzfc8I/AAAAAAAAAdA/XAQB5yDStUc/s1600/eg1.PNG")
```
...
In a $\text{Poisson}(c)$ branching process with $c < 1$, 
$$\mathbb{P}(T > a) \leq \frac{1}{a}\frac{1}{1-c}$$
:::
...
U = np.array([largest_component(n, c/n) for c in C])
